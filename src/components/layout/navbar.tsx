...
const Navbar = () => {
  ...
  return (
    ...
    >
      <div className="lg:bg-popover/90 relative z-50 container grid grid-cols-2 lg:grid-cols-[1fr_auto_1fr] items-center px-4 lg:py-4 lg:pr-4 lg:pl-6 lg:rounded-full lg:border lg:border-border/70 lg:backdrop-blur-md">
