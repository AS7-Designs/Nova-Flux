    ...
    <div className="grid min-h-svh lg:grid-cols-2">
      <div className="container w-full max-w-sm self-center justify-self-center px-4 py-20 lg:px-0 lg:py-0">
        <div className="mb-6 flex items-center justify-center gap-2">
          ...
          <h1 className="font-display text-2xl leading-none font-semibold tracking-tight">Sign in</h1>
        </div>
        <form className={cn("bg-card border-border relative flex flex-col rounded-md border p-6 shadow-none lg:p-8")}>
          {/* Gradient accent at top */}
          <div
            aria-hidden
            className="from-chart-1/30 via-chart-2/15 pointer-events-none absolute top-0 right-0 left-0 h-px bg-gradient-to-r to-transparent"
          />
